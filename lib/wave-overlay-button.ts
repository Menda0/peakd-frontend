/** Single overlay CTA on media (Claim only). */
...
/** Button inside overlay stack (no absolute positioning). */
export const waveOverlayStackItemClassName =
  "h-auto rounded-lg border border-white/15 bg-black/75 px-3 py-1.5 text-xs font-semibold text-zinc-50 shadow-lg backdrop-blur-sm hover:bg-black/85";
